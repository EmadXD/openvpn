...
def run_command(command):
    """Run a shell command and handle errors without stopping the script."""
    try:
...
def main():
    ...
    if os.geteuid() != 0:
        print("[!] This script must be run as root (use sudo). Continuing anyway...")
...
"""
    ...
    try:
        ...
        print(f"[!] Could not configure redsocks: {e}")
    ...
    if pid:
        ...
        print("[!] Redsocks is not running. Please start it manually.")
...
if __name__ == "__main__":
    while True:
        ...
        time.sleep(60)  # هر ۱ دقیقه دوباره اجرا میشه
